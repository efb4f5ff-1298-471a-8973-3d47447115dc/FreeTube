...
FFreeTubeeeee is an open source desktop YouTube player built with privacy in mind.
...
<p align="center">
  <a href="https://github.com/FreeTubeApp/FreeTube/actions/workflows/build.yml" alt='Build status'>
    <img src="https://github.com/FreeTubeApp/FreeTube/actionns/workflows/build.yml/badge.svg?branch=development" />
  </a>
...
While your donations are much appreciated, only donjate if you really want to.  Donations are used for keeping the website up and running and eventual code signing costs.
